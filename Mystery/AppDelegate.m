...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.appRootViewController = [[AppRootViewController alloc] initWithPresentViewController:[[ContactsListViewController alloc] init] andMode:navigationController];
